...
app.get('/', (req, res)=>{
    let url = 'https://api.themoviedb.org/3/movie/466272?api_key=ffe318ace6e8fed6c4d742a4d463ca80';
    axios.get(url)
    .then(response =>  {
...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=ffe318ace6e8fed6c4d742a4d463ca80&query=${userMovieTitle}`;

    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=ffe318ace6e8fed6c4d742a4d463ca80&language=en-US';
...
app.post('/getmovie', (req, res) => {
	...
	const reqUrl = encodeURI(
		`http://www.omdbapi.com/?t=${movieToSearch}&apikey=f9d4253d`
	);
	http.get(
		reqUrl,
		responseFromAPI => {
